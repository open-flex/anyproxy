...
const { RECORD_FILTER: RECORD_FILTER_MENU_KEY, MAP_LOCAL: MAP_LOCAL_MENU_KEY, ROOT_CA: ROOT_CA_MENU_KEY } = MenuKeyMap;
  ...
  render() {
    ...
    return (
      <div className={Style.indexWrapper}>
        ...
        <div className={Style.middlePanel}>{this.getMiddlePanel()}</div>
        <div className={Style.rightPanel}>
          <div className={Style.headerWrapper}>
            <HeaderMenu resumeRefreshFunc={this.resumeFresh} />
          </div>
          <div className={Style.tableWrapper} ref={this.initRecrodPanelWrapperRef}>
            <RecordPanel
