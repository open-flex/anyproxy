...
class RecordDetail extends React.Component {
  ...
  getRecordContentDiv(recordDetail = {}, fetchingRecord) {
    ...
    const websocketMenu = <Menu.Item key={PageIndexMap.WEBSOCKET_INDEX}>WebSocket</Menu.Item>;
    ...
    return (
      <div className={Style.wrapper}>
        ...
        <div className={Style.detailWrapper}>{fetchingRecord ? this.getLoaingDiv() : getMenuBody()}</div>
      </div>
    );
  }
