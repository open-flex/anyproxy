...
const { RECORD_FILTER: RECORD_FILTER_MENU_KEY } = MenuKeyMap;
  ...
  render() {
    ...
    const addressDivs = ipAddress
      ? this.state.ipAddress.map((singleIpAddress) => {
          return (
            <div key={singleIpAddress} className={Style.ipAddress}>
              {singleIpAddress}
            </div>
          );
        })
    ...
    const runningInfoDiv = (
      <div>
        ...
        <div className={Style.okButton}>
          <Button type="primary" onClick={this.handleRuningInfoVisibleChange.bind(this, false)}>
            {' '}
            OK{' '}
          </Button>
        </div>
    ...
    const stopRecordingMenu = (
      <a className={stopMenuStyle} href="javascript:void(0)" onClick={this.stopRecording}>
    ...
    const resumeRecordingMenu = (
      <a className={resumeMenuStyle} href="javascript:void(0)" onClick={this.resumeRecording}>
    ...
    const filterMenu = (
      <a className={showFilterMenuStyle} href="javascript:void(0)" onClick={this.showFilter}>
        <div className={Style.stopIcon}>
    ...
    return (
      <div className={Style.wrapper}>
        <div className={Style.menuList}>
          ...
          <a className={Style.menuItem} href="javascript:void(0)" onClick={this.clearAllRecord} title="Ctrl + X">
          ...
          >
            <a className={runningTipStyle} href="javascript:void(0)">
