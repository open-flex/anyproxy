...
import { showFilter, showRootCA } from 'action/globalStatusAction';

import { MenuKeyMap } from 'common/constant';

const StyleBind = ClassBind.bind(Style);
const { RECORD_FILTER: RECORD_FILTER_MENU_KEY, ROOT_CA: ROOT_CA_MENU_KEY } = MenuKeyMap;
    ...
    return (
      <div className={wrapperStyle}>
        ...
        <div className={Style.bottom}>
          <a className={Style.bottomItem} href="http://anyproxy.io/" target="_blank">
            AnyProxy.io
          </a>
          ...
          <span className={Style.bottomItem}>Version {this.props.globalStatus.appVersion}</span>
        </div>
      </div>
    );
  }
